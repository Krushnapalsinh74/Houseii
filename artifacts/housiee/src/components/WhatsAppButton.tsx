...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-4 bg-white text-[#0F172A] px-3 py-1.5 rounded-md text-sm font-bold shadow-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
        Chat with us
      </span>
    </a>
  );
