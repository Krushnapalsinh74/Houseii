...
export async function seedIfEmpty() {
  try {
    ...
    logger.info("Admin user ensured: admin@housiee.in");
    ...
    logger.info("No properties found — seeding sample data...");
    ...
    await db.insert(propertiesTable).values([
      {
        ...
        rera: "PR/GJ/AHMEDABAD/AUDA/MAA01234/090924", userId: null,
      },
      {
        ...
        rera: "PR/GJ/AHMEDABAD/AUDA/MAB05678/120924", userId: null,
      },
      {
        ...
        rera: "PR/GJ/AHMEDABAD/AUDA/MAC09012/030924", userId: null,
      },
      {
        ...
        rera: "PR/GJ/AHMEDABAD/AUDA/MAD34567/060924", userId: null,
      },
      {
      ...
      },
      {
        ...
        builderName: "Urban Spaces", possession: "Ready to Move", rera: null, userId: null,
      },
      {
    ...
    await db.insert(projectsTable).values([
      {
        ...
        amenities: ["Rooftop Garden", "Infinity Pool", "Gym", "Clubhouse", "EV Charging", "Kids Zone"],
      ...
      },
      {
        ...
        images: ["https://images.unsplash.com/photo-1464082354059-27db6ce50048?w=800&q=80"],
        amenities: ["Township", "Cricket Ground", "Swimming Pool", "School", "Supermarket"],
      ...
      },
      {
        ...
        description: "Premium Grade-A office spaces in GIFT City SEZ. Ideal for IT/ITES companies.",
        images: ["https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80"],
        amenities: ["SEZ Benefits", "Metro Connectivity", "Data Centre", "24x7 Security"],
      ...
      },
      {
        ...
        description: "Exclusive boutique project with only 40 units. 3 & 4 BHK sky residences with spectacular views.",
        images: ["https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80"],
        amenities: ["Sky Deck", "Private Pool", "Concierge", "Smart Home", "EV Parking"],
      ...
      },
      {
        ...
        description: "Row houses and bungalow plots in a gated community with 24x7 security.",
        images: ["https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=800&q=80"],
        amenities: ["Gated Community", "Clubhouse", "Tennis Court", "Garden", "24x7 Security"],
      ...
      },
      {
        ...
        images: ["https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=800&q=80"],
        amenities: ["High Footfall", "Food Court", "Ample Parking", "Power Backup", "CCTV"],
        rera: "PR/GJ/AHMEDABAD/AUDA/PROJ0006/2024", possession: "Sep 2026", featured: false,
      },
    ]);

    await db.insert(inquiriesTable).values([
      { name: "Vikram Mehta", email: "vikram@gmail.com", phone: "9898989898", message: "I am interested in the 3 BHK apartment. Can we schedule a site visit this weekend?", propertyId: null, inquiryType: "property", status: "new" },
      { name: "Sunita Agrawal", email: "sunita@gmail.com", phone: "9787878787", message: "Looking for 2-3 BHK in Bopal or nearby area within 60 Lac budget.", propertyId: null, inquiryType: "general", status: "new" },
      { name: "Deepak Shah", email: "deepak@gmail.com", phone: "9676767676", message: "Interested in the commercial property on SG Highway. Can you provide lease terms?", propertyId: null, inquiryType: "property", status: "contacted" },
      { name: "Kavya Trivedi", email: "kavya@gmail.com", phone: "9565656565", message: "The villa looks amazing! What is the final price? Is vastu compliance confirmed?", propertyId: null, inquiryType: "property", status: "contacted" },
      { name: "Manish Gupta", email: "manish@gmail.com", phone: "9454545454", message: "I need commercial space for my IT startup. Around 2000 sqft in GIFT City or SG Highway.", propertyId: null, inquiryType: "general", status: "resolved" },
      { name: "Pooja Bansal", email: "pooja@gmail.com", phone: "9343434343", message: "Interested in the studio apartment for investment. What is the expected rental yield?", propertyId: null, inquiryType: "property", status: "new" },
      { name: "Ravi Nair", email: "ravi@gmail.com", phone: "9232323232", message: "We are NRI looking to invest in Ahmedabad. Please share details about 3-4 BHK apartments.", propertyId: null, inquiryType: "general", status: "new" },
      { name: "Archana Modi", email: "archana@gmail.com", phone: "9121212121", message: "Saw the penthouse listing. Can you arrange a private viewing? We are serious buyers.", propertyId: null, inquiryType: "property", status: "contacted" },
    ]);

    await db.insert(testimonialsTable).values([
      { clientName: "Rajesh & Meena Patel", clientImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&q=80", review: "HOUSIEE made our dream home a reality. Transparent process and no hidden charges. Highly recommended!", rating: 5, propertyBought: "3 BHK in Prahlad Nagar", location: "Ahmedabad" },
      { clientName: "Ankit Shah", clientImage: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&q=80", review: "Excellent service! Found me the perfect office in SG Highway within my budget. Professional and responsive.", rating: 5, propertyBought: "Office Space in SG Highway", location: "Ahmedabad" },
      { clientName: "Priyanka & Nitin Desai", clientImage: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&q=80", review: "Bought our villa through HOUSIEE and the experience was seamless. They helped with legal documentation too.", rating: 5, propertyBought: "4 BHK Villa in Bodakdev", location: "Ahmedabad" },
      { clientName: "Suresh Kumar", clientImage: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&q=80", review: "Great platform with genuine listings. No fake photos or misleading prices. Very knowledgeable about Ahmedabad market.", rating: 4, propertyBought: "2 BHK in Bopal", location: "Ahmedabad" },
      { clientName: "Jyoti Acharya", clientImage: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&q=80", review: "As an NRI buyer, HOUSIEE handled everything remotely. Got possession without any hassle. Outstanding service!", rating: 5, propertyBought: "3 BHK in Satellite", location: "Ahmedabad" },
    ]);

    await db.insert(blogPostsTable).values([
      { title: "Top 10 Residential Areas to Buy Property in Ahmedabad 2025", slug: "top-10-residential-areas-ahmedabad-2025", excerpt: "Ahmedabad real estate is booming. Here are the top 10 localities offering best value and appreciation potential.", content: "Ahmedabad has emerged as one of India's most vibrant real estate markets...", category: "Investment", coverImage: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80", author: "HOUSIEE Team", readTime: 6 },
      { title: "RERA in Gujarat: Everything Home Buyers Need to Know", slug: "rera-gujarat-home-buyers-guide", excerpt: "Understanding RERA protection and your rights as a buyer under the Real Estate Regulation Act in Gujarat.", content: "The Real Estate (Regulation and Development) Act, 2016, commonly known as RERA...", category: "Legal", coverImage: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=800&q=80", author: "HOUSIEE Legal Team", readTime: 8 },
      { title: "Bopal vs Prahlad Nagar: Which is Better for Investment?", slug: "bopal-vs-prahlad-nagar-investment", excerpt: "A detailed comparison of two of Ahmedabad's most popular residential micro-markets.", content: "When it comes to residential investment in Ahmedabad, Bopal and Prahlad Nagar...", category: "Investment", coverImage: "https://images.unsplash.com/photo-1560472355-536de3962603?w=800&q=80", author: "HOUSIEE Team", readTime: 5 },
      { title: "Home Loan Guide 2025: Best Banks and Interest Rates", slug: "home-loan-guide-2025", excerpt: "Compare home loan interest rates from SBI, HDFC, ICICI and tips to maximize your loan eligibility.", content: "Getting a home loan is now easier than ever with competitive rates...", category: "Finance", coverImage: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&q=80", author: "HOUSIEE Finance Team", readTime: 7 },
      { title: "Commercial Real Estate in Ahmedabad: The GIFT City Opportunity", slug: "commercial-real-estate-gift-city-ahmedabad", excerpt: "GIFT City is transforming Ahmedabad's commercial landscape for savvy investors.", content: "Gujarat International Finance Tec-City (GIFT City) is India's first operational...", category: "Commercial", coverImage: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80", author: "HOUSIEE Commercial Team", readTime: 9 },
      { title: "Vastu Shastra Tips for Your New Home in Ahmedabad", slug: "vastu-shastra-tips-new-home-ahmedabad", excerpt: "Key Vastu principles every Ahmedabad home buyer should know before finalizing their property.", content: "Vastu Shastra has been an integral part of Indian home buying decisions...", category: "Lifestyle", coverImage: "https://images.unsplash.com/photo-1513694203232-719a280e022f?w=800&q=80", author: "HOUSIEE Team", readTime: 4 },
    ]).onConflictDoNothing();

    logger.info("Seed complete: properties, projects, inquiries, testimonials, blog posts added.");
  } catch (err) {
    logger.error({ err }, "Seed error — server will continue without sample data.");
  }
}
